...
void setup() {
  ...
  setupEncoder0();
  setupEncoder1();
  spd_pid_left.initialize( 30.0, 0.0 , 0.0);
  spd_pid_right.initialize( 30.0, 0.0 , 0.0);
  ls.led_init();
...
void loop() {
  ...
  if (state == 0) {
    ...
    motorStraight(16.25, 16.25); // This speed was found to be the optimal based on our experiments,
                                 // and the same was used to find the errors in experiments with diff angles. 
    //motorStraight(10, 10);
    //motorStraight(15, 15);
    //motorStraight(17.5, 17.5);
    //motorStraight(25, 25);
    //motorStraight(32.5, 32.5);
    bumpSense();
  }
